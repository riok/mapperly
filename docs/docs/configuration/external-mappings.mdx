...
This can be done through the `UseStaticMapper` attribute.

<Tabs>
    <TabItem value="global-typeof" label="With typeof parameter" default>
    ...
    <TabItem value="global-generic" label="With generic argument">
        ...
        [assembly: UseStaticMapper<BananaMapper>]
        [assembly: UseStaticMapper<AppleMapper>]
        ```
...
This will make the static mapping methods of the specified mapper classes available globally.
