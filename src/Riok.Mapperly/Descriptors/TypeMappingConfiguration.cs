...
public record TypeMappingConfiguration(string? StringFormat = null, string? FormatProviderName = null, string? UseNamedMapping = null, bool SuppressNullMismatchDiagnostic = false)
{
