...
{
    [Fact]
    public void ParseableCustomClassWithFormatProvider_FormatProviderNotDefined()
    {
    ...
    [Fact]
    public void ParseableCustomClassWithFormatProvider_DefaultFormatProviderDefined()
    {
    ...
    [Fact]
    public void ParseableCustomClassWithFormatProvider_NamedFormatProviderDefined()
    {
        var source = TestSourceBuilder.MapperWithBodyAndTypes(
            """
            [FormatProvider(Default = true)]
