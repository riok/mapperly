...
namespace Riok.Mapperly.IntegrationTests.Mapper
{
    public static partial class StaticTestMapper
    {
        ...
        public static partial Riok.Mapperly.IntegrationTests.Dto.TestObjectDto MapToDtoExt(this Riok.Mapperly.IntegrationTests.Models.TestObject src)
        {
            ...
            target.ImmutableArrayValue = System.Collections.Immutable.ImmutableArray.ToImmutableArray(System.Linq.Enumerable.Select(src.ImmutableArrayValue, x1 => ParseableInt(x1)));
            target.ImmutableListValue = System.Collections.Immutable.ImmutableList.ToImmutableList(System.Linq.Enumerable.Select(src.ImmutableListValue, x2 => ParseableInt(x2)));
            target.ImmutableHashSetValue = System.Collections.Immutable.ImmutableHashSet.ToImmutableHashSet(System.Linq.Enumerable.Select(src.ImmutableHashSetValue, x3 => ParseableInt(x3)));
            target.ImmutableQueueValue = System.Collections.Immutable.ImmutableQueue.CreateRange(System.Linq.Enumerable.Select(src.ImmutableQueueValue, x4 => ParseableInt(x4)));
            target.ImmutableStackValue = System.Collections.Immutable.ImmutableStack.CreateRange(System.Linq.Enumerable.Select(src.ImmutableStackValue, x5 => ParseableInt(x5)));
            target.ImmutableSortedSetValue = System.Collections.Immutable.ImmutableSortedSet.ToImmutableSortedSet(System.Linq.Enumerable.Select(src.ImmutableSortedSetValue, x6 => ParseableInt(x6)));
